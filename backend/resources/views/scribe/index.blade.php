...
Must be one of:
<ul style="list-style-type: square;"><li><code>new</code></li> <li><code>processing</code></li> <li><code>pending</code></li> <li><code>payed</code></li> <li><code>payment_review</code></li> <li><code>refunded</code></li> <li><code>shipped</code></li> <li><code>delivered</code></li> <li><code>canceled</code></li> <li><code>closed</code></li></ul>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
        <details>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="customer_id"                data-endpoint="PUTapi-orders--order_id-"
               value="architecto"
               data-component="body">
    <br>
<p>The <code>id</code> of an existing record in the customers table. Example: <code>architecto</code></p>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="products.0.id"                data-endpoint="PUTapi-orders--order_id-"
               value=""
               data-component="body">
    <br>
...
<i>optional</i> &nbsp;
                <input type="number" style="display: none"
               step="any"               name="products.0.quantity"                data-endpoint="PUTapi-orders--order_id-"
               value="22"
               data-component="body">
    <br>
<p>This field is required when <code>products</code> is present. Must be at least 1. Example: <code>22</code></p>
                    </div>
                                    </details>
        </div>
        </form>
